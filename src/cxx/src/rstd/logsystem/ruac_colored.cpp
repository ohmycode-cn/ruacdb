...
namespace ruac::rstd::logsystem {
     ...
     */
    Colored::Colored(const bool enable_ce_, const bool enable_ht_, const bool enable_bf_) {
     ...
     * @param enable_bf_  Enable bold font weight instead of normal.
     */
    void Colored::init(const bool enable_ce_, const bool enable_ht_, const bool enable_bf_) {
